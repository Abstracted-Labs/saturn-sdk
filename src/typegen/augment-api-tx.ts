...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    rings: {
      bridgeAssets: AugmentedSubmittable<(asset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | { Bifrost: any } | string | Uint8Array, destination: TinkernetRuntimeRingsChains | 'Kusama' | 'Basilisk' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | 'Bifrost' | number | Uint8Array, fee: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, to: Option<AccountId32> | null | Uint8Array | AccountId32 | string) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChainAssets, TinkernetRuntimeRingsChains, u128, u128, Option<AccountId32>]>;
      sendCall: AugmentedSubmittable<(destination: TinkernetRuntimeRingsChains | 'Kusama' | 'Basilisk' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | 'Bifrost' | number | Uint8Array, weight: u64 | AnyNumber | Uint8Array, feeAsset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | { Bifrost: any } | string | Uint8Array, fee: u128 | AnyNumber | Uint8Array, call: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChains, u64, TinkernetRuntimeRingsChainAssets, u128, Bytes]>;
      setMaintenanceStatus: AugmentedSubmittable<(chain: TinkernetRuntimeRingsChains | 'Kusama' | 'Basilisk' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | 'Bifrost' | number | Uint8Array, underMaintenance: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChains, bool]>;
      transferAssets: AugmentedSubmittable<(asset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | { Bifrost: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, to: AccountId32 | string | Uint8Array, feeAsset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | { Bifrost: any } | string | Uint8Array, fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChainAssets, u128, AccountId32, TinkernetRuntimeRingsChainAssets, u128]>;
    };
    scheduler: {
      /**
