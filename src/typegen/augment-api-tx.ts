...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    rings: {
      bridgeAssets: AugmentedSubmittable<(asset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | string | Uint8Array | Object, destination: TinkernetRuntimeRingsChains | 'Basilisk' | 'Kusama' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | number | Uint8Array | string, fee: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, to: Option<AccountId32> | null | Uint8Array | AccountId32 | string) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChainAssets, TinkernetRuntimeRingsChains, u128, u128, Option<AccountId32>]>;
      sendCall: AugmentedSubmittable<(destination: TinkernetRuntimeRingsChains | 'Basilisk' | 'Kusama' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | number | Uint8Array | string, weight: u64 | AnyNumber | Uint8Array, feeAsset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | string | Uint8Array | Object, fee: u128 | AnyNumber | Uint8Array, call: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChains, u64, TinkernetRuntimeRingsChainAssets, u128, Bytes]>;
      setMaintenanceStatus: AugmentedSubmittable<(chain: TinkernetRuntimeRingsChains | 'Basilisk' | 'Kusama' | 'Statemine' | 'Shiden' | 'Khala' | 'Kintsugi' | number | Uint8Array, underMaintenance: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChains, bool]>;
      transferAssets: AugmentedSubmittable<(asset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | string | Uint8Array | Object, amount: u128 | AnyNumber | Uint8Array, to: AccountId32 | string | Uint8Array, feeAsset: TinkernetRuntimeRingsChainAssets | { Basilisk: any } | { Kusama: any } | { Statemine: any } | { Shiden: any } | { Khala: any } | { Kintsugi: any } | string | Uint8Array | Object, fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [TinkernetRuntimeRingsChainAssets, u128, AccountId32, TinkernetRuntimeRingsChainAssets, u128]>;
    };
    scheduler: {
      /**
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[u32, u128]>> | ([u32 | AnyNumber | Uint8Array, u128 | AnyNumber | Uint8Array])[], feeItem: u32 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeightLimit: XcmV2WeightLimit | { Unlimited: any } | { Limited: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[u32, u128]>>, u32, XcmVersionedMultiLocation, XcmV2WeightLimit]>;
      /**
